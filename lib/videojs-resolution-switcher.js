/*! videojs-resolution-switcher - v0.4.2 - 2016-09-02
* Copyright (c) 2016 [object Object]; Licensed Apache-2.0 */
     ...
     var ResolutionMenuButton = videojs.extend(MenuButton, {
       constructor: function(player, options, settings, label){
        ...
        if(settings.dynamicLabel){
          ...
          var staticLabel = document.createElement('button');
          // custom button, using material icons
          staticLabel.className = 'vjs-resolution-button-staticlabel vjs-control vjs-button material-icons';
          staticLabel.innerHTML = 'settings';
        ...
        if(!hls) { return; }
				...
				player.one('loadedmetadata', function(){
					...
					var _customSourcePicker = function(_player, _sources, _label){
						...
						// custom trigger event to know when user has tried to make a change
						player.trigger('resolutionrequest', selectedRes);
					...
					menuButton.el().classList.add('vjs-resolution-button');
					player.controlBar.resolutionSwitcher = player.controlBar.addChild(menuButton);
					player.controlBar.el().insertBefore(player.controlBar.resolutionSwitcher.el(), this.controlBar.fullscreenToggle.el());
				});
			}
